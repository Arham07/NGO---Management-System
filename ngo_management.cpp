...
int WelfareOrganization::Cash;
int WelfareOrganization::totalDonors;
int WelfareOrganization::totalDonation;
...
public:
       void HISTORY()
       {
              cout << "We Have " << WelfareOrganization::totalDonation << "RS//- in our account." << endl;
       }
};
